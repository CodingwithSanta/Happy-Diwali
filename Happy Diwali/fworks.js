    ...
    var Fireworks = function () {
        ...
        self.updateFireworks = function () {
            ...
            while (i--) {
                ...
                if (f.startX >= f.targetX) {
                    f.x += f.x + vx <= f.targetX ? (f.x = f.targetX, f.hitX = true) : vx;
                } else {
                    f.x += f.x + vx >= f.targetX ? (f.x = f.targetX, f.hitX = true) : vx;
                }

                if (f.startY >= f.targetY) {
                    f.y += f.y + vy <= f.targetY ? (f.y = f.targetY, f.hitY = true) : vy;
                } else {
                    f.y += f.y + vy >= f.targetY ? (f.y = f.targetY, f.hitY = true) : vy;
                }
        ...
        self.bindEvents = function () {
            ...
            $(document).on('mousedown', function (e) {
                var randLaunch = setTimeout(function () {
                    self.mx = e.pageX - $(self.canvas).offset().left;
                    self.my = e.pageY - $(self.canvas).offset().top;
